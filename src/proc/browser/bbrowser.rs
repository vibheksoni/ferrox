...
pub fn find_path() -> Option<String> {
    let paths = [
        sprotect!("SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\App Paths\\brave.exe"),
        sprotect!("SOFTWARE\\WOW6432Node\\Microsoft\\Windows\\CurrentVersion\\App Paths\\brave.exe"),
    ];
    ...
    let additional_paths = [
        sprotect!("C:\\Program Files\\BraveSoftware\\Brave-Browser\\Application\\brave.exe"),
        sprotect!("C:\\Program Files (x86)\\BraveSoftware\\Brave-Browser\\Application\\brave.exe"),
    ];
